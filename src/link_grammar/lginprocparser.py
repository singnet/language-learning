...
class LGInprocParser(AbstractFileParserClient):
    ...
    def _handle_stream_output(self, text: str, options: int, out_stream):
        """
    ...
    def parse(self, dict_path: str, corpus_path: str, output_path: str, options: int) \
            -> ParseMetrics:
        """
        ...
        try:
            ...
            with Popen(["grep", "-P", reg_exp, corpus_path], stdout=PIPE) as proc_grep, \
                ...
                ret_metrics += self._handle_stream_output(raw.decode(), options, out_stream)
